...
// +-----------------------------------------------------------
namespace Namesfang\WeChat\Mini\QRCode;

use Namesfang\WeChat\Mini\QRCode\Log\LoggerInterface;
...
class Request
{
     ...
     * @param string $value
     * @return \Namesfang\WeChat\Mini\QRCode\Request
     */
    ...
    /**
     * 发起GET请求
     * @return \Namesfang\WeChat\Mini\QRCode\Response
     */
    public function get()
    {
        return $this->send();
    ...
    protected function setPostFields($fields)
    {
